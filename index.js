...
const nameValidator = (value) =>
  /[a-z0-9]+(?:(?:(?:[._]|__|[-]*)[a-z0-9]+)+)?/.test(value) || 'Name not valid'
...
const createProject = (props) => {
  ...
  libraries.forEach((library) => {
    ...
    setupLib(libSetup, manager, bundler, project)
  })
  ...
  ADDONS.forEach((addon) => {
    if (props[addon]) {
      ...
      setupLib(addonSetup, manager, bundler, project)
    }
  })
...
const setupLib = (library, manager, bundler, project) => {
